...
export type CreateRiskModelArgs = z.infer<typeof import('../../command-defs/research.js').createRiskModelSchema>;

export async function createRiskModelHandler(
  args: CreateRiskModelArgs,
  ctx: CommandContext
) {
