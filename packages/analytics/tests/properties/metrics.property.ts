        ...
        fc.property(
          fc.array(
            fc.record({
              ...
              entryPrice: fc.float({ min: 0.0001, max: 1000 }),
              athPrice: fc.float({ min: 0.0001, max: 10000 }),
              athMultiple: fc.float({ min: 0, max: 1000 }),
              timeToAthMinutes: fc.float({ min: 0, max: 10000 }),
              atlPrice: fc.float({ min: 0.0001, max: 1000 }),
              atlMultiple: fc.float({ min: 0.1, max: 10 }),
            }),
