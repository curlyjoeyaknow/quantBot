...
exports.ingestJsonExport = ingestJsonExport;
const path = __importStar(require("path"));
const utils_1 = require("@quantbot/utils");
const TelegramJsonExportParser_1 = require("./TelegramJsonExportParser");
const TelegramMessageStreamProcessor_1 = require("./TelegramMessageStreamProcessor");
/**
 * Ingest a Telegram JSON export file with normalization and quarantine
 */
async function ingestJsonExport(params) {
    utils_1.logger.info('Starting Telegram JSON export ingestion', {
        filePath: params.filePath,
        chatId: params.chatId,
    });
    // 1. Parse and normalize: raw -> normalize
    const parseResult = (0, TelegramJsonExportParser_1.parseJsonExport)(params.filePath, params.chatId);
    utils_1.logger.info('Normalization complete', {
    ...
    if (params.writeStreams !== false) {
        ...
        const processor = new TelegramMessageStreamProcessor_1.TelegramMessageStreamProcessor({
        ...
        utils_1.logger.info('Streams written', {
...
//# sourceMappingURL=TelegramJsonIngestionService.js.map