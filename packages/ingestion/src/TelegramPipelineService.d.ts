 ...
 */
export declare const TelegramPipelineResultSchema: import('zod').ZodType<import('@quantbot/utils').PythonManifest>;
...
export declare class TelegramPipelineService {
     ...
     */
    runPipeline(inputFile: string, outputDb: string, chatId: string, rebuild?: boolean): Promise<TelegramPipelineResult>;
}
