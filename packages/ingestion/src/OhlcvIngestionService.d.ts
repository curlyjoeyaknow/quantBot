...
export declare class OhlcvIngestionService {
    ...
    constructor(alertsRepo: AlertsRepository, ingestionEngine?: import('@quantbot/jobs').OhlcvIngestionEngine, storageEngine?: import('@quantbot/storage').StorageEngine, pythonEngine?: PythonEngine);
    /**
