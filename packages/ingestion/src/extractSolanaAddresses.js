...
function isValidSolanaAddress(address) {
    ...
    if (address.toUpperCase().startsWith('DEF'))
        return false;
...
function extractSolanaAddresses(text) {
    ...
    const urlRegex = /(?:pump\.fun|birdeye\.so|solscan\.io|solana\.fm)[/=]([1-9A-HJ-NP-Za-km-z]{32,44})/gi;
...
//# sourceMappingURL=extractSolanaAddresses.js.map