...
import type {
  ...
  SignalGroup,
  SimulationResult,
} from '@quantbot/simulation/types';
import type { ExtendedSimulationResult } from '@quantbot/simulation/types/results';
import type { PeriodMetricsConfig } from '@quantbot/simulation/config';
import { fetchHybridCandlesWithMetadata } from '@quantbot/ohlcv';
import type { TokenMetadata } from '@quantbot/core';
import { simulateStrategy, type SimulationOptions } from '@quantbot/simulation/core/simulator';
import { getResultCache, type ResultCacheConfig } from '../storage/result-cache';
import { getPerformanceMonitor } from '@quantbot/simulation/performance/monitor';
import { enrichSimulationResultWithPeriodMetrics } from '@quantbot/simulation/period-metrics/period-metrics';
...
export class SimulationOrchestrator {
  private sinks: SimulationResultSink[];
