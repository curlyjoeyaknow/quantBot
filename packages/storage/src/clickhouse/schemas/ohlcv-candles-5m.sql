-- OHLCV Candles 5-minute Table
-- Stores 5-minute candles with quality-based deduplication.
...
CREATE TABLE IF NOT EXISTS quantbot.ohlcv_candles_5m (
    ...
    chain String,
    timestamp DateTime,
    interval_seconds UInt32 DEFAULT 300,  -- Always 300 for this table, for batch exports
    open Float64,
    high Float64,
    low Float64,
    close Float64,
...
ALTER TABLE quantbot.ohlcv_candles_5m
