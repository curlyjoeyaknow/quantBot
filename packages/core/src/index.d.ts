 ...
 * ```
 */
export declare function createTokenAddress(address: string): TokenAddress;
/**
 ...
 * ```
 */
export type SimulationEvent = EntryEvent | TrailingEntryTriggeredEvent | ReEntryEvent | LadderEntryEvent | StopMovedEvent | TargetHitEvent | StopLossEvent | LadderExitEvent | FinalExitEvent;
/**
 * Simulation result
 */
