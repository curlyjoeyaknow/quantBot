...
import type { EventLogService } from '../observability/index.js';
import type { PrometheusMetricsService } from '../observability/index.js';
  ...
  constructor(config: BaseApiClientConfig) {
    ...
    this.axiosInstance.interceptors.response.use(
      ...
      async (error: AxiosError) => {
        const startTime = (error.config as AxiosRequestConfig & { _startTime?: number })
          ?._startTime;
