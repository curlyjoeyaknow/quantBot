...
describe('OHLCVQueryService', () => {
    ...
    describe('getOHLCV', () => {
        ...
        it('should query InfluxDB when cache miss', async () => {
            ...
            const result = await service.getOHLCV(TEST_MINT, startTime, endTime, '1m');
            expect(mockInfluxClient.getOHLCVData).toHaveBeenCalledWith(TEST_MINT, startTime, endTime, '1m');
    ...
    describe('getAvailableTokens', () => {
        it('should return available tokens', async () => {
            const tokens = [{ address: TEST_MINT, symbol: 'TEST', name: 'Test Token' }];
...
//# sourceMappingURL=ohlcv-query.test.js.map