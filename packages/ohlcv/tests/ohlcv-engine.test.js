...
vi.mock('@quantbot/storage', async () => {
    ...
    globalThis.__ohlcvEngineStorageMocks__ = {
        mockStorage,
        mockStorageEngine,
    };
    return mockStorage;
...
describe('OHLCVEngine', () => {
    ...
    beforeEach(() => {
        ...
        const mocks = globalThis.__ohlcvEngineStorageMocks__;
    ...
    describe('fetch', () => {
        ...
        it('should use ClickHouse cache when available', async () => {
            ...
            expect(mockStorageEngine.getCandles).toHaveBeenCalledWith(FULL_MINT, // Full address, case-preserved
            'solana', startTime, endTime, { interval: '5m' });
        ...
        it('should preserve exact case of mint address', async () => {
            ...
            expect(mockStorageEngine.getCandles).toHaveBeenCalledWith(FULL_MINT_LOWERCASE, // Exact case preserved
            'solana', startTime, endTime, { interval: '5m' });
        });
        ...
        it('should handle alert time for 1m candles', async () => {
            ...
            const candles1m = Array.from({ length: 60 }, (_, i) => ({
            ...
            expect(mockStorageEngine.getCandles).toHaveBeenCalledWith(FULL_MINT, 'solana', startTime, endTime, { interval: '1m' });
...
//# sourceMappingURL=ohlcv-engine.test.js.map