...
exports.BacktestCallCommandHandler = void 0;
...
class BacktestCallCommandHandler extends CommandHandler_1.BaseCommandHandler {
    constructor(sessionService, simulationService) {
        super();
        this.sessionService = sessionService;
        this.simulationService = simulationService;
        this.command = 'backtest_call';
    }
        ...
        try {
            ...
            if (!call) {
                await ctx.reply(`❌ **CA Call Not Found**\n\n` +
                    ...
                    `Use \`/history\` to see available calls.`, { parse_mode: 'Markdown' });
                return;
            }
            ...
            await ctx.reply(`🎯 **Backtesting Historical Call**\n\n` +
                ...
                `Running simulation with default strategy...`, { parse_mode: 'Markdown' });
            ...
            try {
                ...
                const result = (0, simulate_1.simulateStrategy)(candles, newSession.data.strategy, newSession.data.stopLossConfig, newSession.data.entryConfig, newSession.data.reEntryConfig);
                ...
                logger_1.logger.error('Simulation error', simError, { userId, mint });
...
exports.BacktestCallCommandHandler = BacktestCallCommandHandler;
//# sourceMappingURL=BacktestCallCommandHandler.js.map