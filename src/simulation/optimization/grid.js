...
exports.generateFocusedGrid = generateFocusedGrid;
/**
 * Generate all parameter combinations from a grid
 */
function generateParameterCombinations(grid, baseStrategy) {
    const combinations = [];
    // Default values
 ...
 */
function generateFocusedGrid(baseStrategy, variations = {}) {
    const grid = {};
