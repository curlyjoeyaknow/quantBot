...
export declare class TenkanKijunAlertService extends EventEmitter {
     ...
     */
    addMonitor(tokenAddress: string, tokenSymbol: string, chain: string, callerName: string, alertTime: Date, alertPrice: number): Promise<void>;
    /**
     * Add a token to monitor manually
     */
    addToken(tokenAddress: string, tokenSymbol: string, chain: string, callerName: string, alertTime: DateTime, alertPrice: number): Promise<void>;
}
