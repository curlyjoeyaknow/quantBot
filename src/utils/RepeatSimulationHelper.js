...
exports.RepeatSimulationHelper = void 0;
class RepeatSimulationHelper {
     ...
     */
    async repeatSimulation(ctx, run) {
        ...
        await ctx.reply(`🔄 **Repeating Simulation**\n\n` +
            ...
            `• \`[{"percent":0.5,"target":2}]\` - JSON`, { parse_mode: 'Markdown' });
    }
}
exports.RepeatSimulationHelper = RepeatSimulationHelper;
//# sourceMappingURL=RepeatSimulationHelper.js.map