...
export class ServiceContainer {
  ...
  private initializeServices(): void {
    ...
    // Text workflow handler (depends on multiple services)
    this.registerService('textWorkflowHandler', () => {
      const sessionService = this.getService<SessionService>('sessionService');
      ...
      const ichimokuWorkflowService = this.getService<IchimokuWorkflowService>('ichimokuWorkflowService');
      const caDetectionService = this.getService<CADetectionService>('caDetectionService');
      const repeatHelper = this.getService<RepeatSimulationHelper>('repeatSimulationHelper');
      
      return new TextWorkflowHandler(
        sessionService,
        simulationService,
        strategyService,
        ichimokuWorkflowService,
        caDetectionService,
        repeatHelper
      );
    });
