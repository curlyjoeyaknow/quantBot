 ...
 */
export declare function decodeBondingCurveAccount(data: Buffer | Uint8Array | string): BondingCurveAccount | null;
/**
 ...
 */
export declare function calculatePriceFromBondingCurve(account: BondingCurveAccount, solPriceUsd?: number): number;
