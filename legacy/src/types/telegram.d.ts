 ...
 */
export declare function isCallbackQuery(update: Update): update is Update.CallbackQueryUpdate;
/**
 * Type guard for message update
 */
export declare function isMessageUpdate(update: Update): update is Update.MessageUpdate;
/**
 * Type guard for text message
 */
export declare function isTextMessage(message: Message): message is Message.TextMessage;
