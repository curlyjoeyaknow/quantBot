...
export default defineConfig({
  ...
  resolve: {
    alias: {
      // New consolidated packages (must come first for proper resolution)
      ...
      '@quantbot/simulation/*': resolveFromRoot('packages/simulation/src/*'),
      '@quantbot/lab': resolveFromRoot('packages/lab/src'),
      '@quantbot/lab/*': resolveFromRoot('packages/lab/src/*'),
      // Core package
      '@quantbot/core': resolveFromRoot('packages/core/src'),
      '@quantbot/core/*': resolveFromRoot('packages/core/src/*'),
      // Legacy packages (backward compatibility shims)
