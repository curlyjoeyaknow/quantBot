 ...
 *
 * NOTE: @quantbot/data package was removed and consolidated into @quantbot/storage.
 * This file should be updated to use @quantbot/storage for Postgres operations.
 */

// TODO: Update to use @quantbot/storage for Postgres operations
...
// TODO: Import these from @quantbot/storage (replaces @quantbot/data)
const queryPostgres = async <T = unknown>(
  query: string,
  params?: Array<unknown>
): Promise<QueryResult> => {
  throw new AppError(
    'queryPostgres not implemented - should use @quantbot/storage',
    'NOT_IMPLEMENTED',
    501
  );
};
...
const withPostgresTransaction = async <T>(
  ...
  throw new AppError(
    'withPostgresTransaction not implemented - should use @quantbot/storage',
    'NOT_IMPLEMENTED',
    501
  );
};
