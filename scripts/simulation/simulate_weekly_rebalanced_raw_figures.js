...
function createWeeklyRebalancedComparisonReport(allResults) {
    ...
    // Create data table with raw dollar figures
    ...
    fs.writeFileSync('/home/memez/quantBot/weekly_rebalanced_2_5_percent_raw_figures.json', JSON.stringify({
    ...
    console.log('\nWeekly rebalanced comparison saved to weekly_rebalanced_2_5_percent_raw_figures.json');
    
    // Create CSV for easy analysis
    const csvWriter = createCsvWriter({
        path: '/home/memez/quantBot/weekly_rebalanced_2_5_percent_raw_figures.csv',
        header: [
    ...
    csvWriter.writeRecords(comparison)
        .then(() => {
            console.log('Weekly rebalanced comparison CSV saved to weekly_rebalanced_2_5_percent_raw_figures.csv');
        })
        .catch(console.error);
}
