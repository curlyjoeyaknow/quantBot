...
import { loadResults } from './view-scored-results';
 ...
 */
function generateHTML(results: ScoredToken[], outputPath: string): void {
...
<body>
  ...
  logger.info('HTML viewer generated', { outputPath, tokenCount: results.length });
}
