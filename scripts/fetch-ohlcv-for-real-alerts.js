...
const ohlcvService = new services_1.OHLCVIngestionService();
async function main() {
  ...
  `);
    ...
    for (let i = 0; i < result.rows.length; i++) {
        ...
        try {
            ...
            const result = await ohlcvService.fetchAndStoreOHLCV(token.address, startTime, endTime, symbol, token.chain);
...
//# sourceMappingURL=fetch-ohlcv-for-real-alerts.js.map