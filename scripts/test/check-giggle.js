...
async function checkGiggle() {
    ...
    const dates = [
        ...
        luxon_1.DateTime.fromISO('2025-09-10T12:00:00.000Z')
    ];
    for (const alertDate of dates) {
        ...
        const candles = await (0, candles_1.fetchHybridCandles)(tokenAddress, alertDate, endDate, 'bsc');
...
//# sourceMappingURL=check-giggle.js.map