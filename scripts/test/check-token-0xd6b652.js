...
async function checkToken() {
    ...
    const dates = [
        luxon_1.DateTime.fromISO('2025-09-10T00:00:00.000Z'),
        luxon_1.DateTime.fromISO('2025-09-21T17:09:00.000Z') // Actual call from CSV
    ];
    ...
    for (const alertDate of dates) {
        ...
        try {
            const candles = await (0, candles_1.fetchHybridCandles)(tokenAddress, alertDate, endDate, chain);
...
//# sourceMappingURL=check-token-0xd6b652.js.map